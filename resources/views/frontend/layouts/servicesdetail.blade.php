...
<head>
    ...
    @if (!empty($data['favicon']))
        <link rel="shortcut icon"
            href="{{ asset('assets/admin/assets/build/assets/images/uploads/icons/' . $data['favicon']) }}"
            type="image/x-icon">
        <link rel="icon"
            href="{{ asset('assets/admin/assets/build/assets/images/uploads/icons/' . $data['favicon']) }}"
            type="image/x-icon">
    @else
        <link rel="shortcut icon" href="{{ asset('assets/admin/assets/build/assets/images/brand-logos/favicon.ico') }}"
            type="image/x-icon">
...
<body>
    <div class="page-wrapper">
        ...
        <section class="page-title"
            style="background-image:url({{ asset('assets/frontend/images/background/5.jpg') }});">
