    ...
    <div class="container py-5">
        <div class="services-detail">
            ...
            <div class="text">
                ...
                <figure>
                    <img src="{{ asset('assets/frontend/images/resource/n_mixandn-Bmix.jpeg') }}" alt="" />
                </figure>
                <p>
                ...
                <div class="container py-4">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-center">
                            <img src="{{ asset('assets/frontend/images/resource/ser1.jpeg') }}" width="60%" alt="Equipment Image"
                    ...
                    <div class="row align-items-center">
                        <!-- Left Side - Image -->
                        <div class="col-md-4 text-center">
                            <img src="{{ asset('assets/frontend/images/resource/ser2.jpeg') }}" width="80%"
