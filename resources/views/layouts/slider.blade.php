        ...
        <div class="tp-banner">
            <ul>
                ...
                <li data-transition="fade" data-slotamount="1" data-masterspeed="1000"
                    data-thumb="{{ asset('assets/images/main-slider/image-1.jpg') }}" data-saveperformance="off"
                    data-title="Awesome Title Here">
                    <img src="{{ asset('assets/images/main-slider/image-1.jpg') }}" alt=""
                ...
                <li data-transition="fade" data-slotamount="1" data-masterspeed="1000"
                    data-thumb="{{ asset('assets/images/main-slider/image-2.jpg') }}" data-saveperformance="off"
                    data-title="Awesome Title Here">
                    <img src="{{ asset('assets/images/main-slider/image-2.jpg') }}" alt=""
                        data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                ...
                <li data-transition="fade" data-slotamount="1" data-masterspeed="1000"
                    data-thumb="{{ asset('assets/images/main-slider/image-3.jpg') }}" data-saveperformance="off"
                    data-title="Awesome Title Here">
                    <img src="{{ asset('assets/images/main-slider/image-3.jpg') }}" alt=""
                        data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
