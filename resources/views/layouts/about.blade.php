    ...
    <div class="page-wrapper">
        ...
        <div class="container my-5 py-5">
            ...
            <div class="image-gallery">
                <img src="{{ asset('assets/images/resource/about1.jpg') }}" alt="about1" class="gallery-img">
                <img src="{{ asset('assets/images/resource/about2.jpg') }}" alt="about2" class="gallery-img">
            </div>
